...
const config: runtime.GetPrismaClientConfig = {
  "generator": {
    ...
    "output": {
      "value": "/Users/jcm/Programmation/nx-recipes-main/nestjs-prisma/libs/prisma-schema-one/generated/prisma_one",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/Users/jcm/Programmation/nx-recipes-main/nestjs-prisma/libs/prisma-schema-one/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativePath": "../../prisma",
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        "fromEnvVar": "DATABASE_ONE_URL",
        "value": null
      }
    }
  },
  "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\ngenerator client {\n  provider = \"prisma-client\"\n  output   = \"../generated/prisma_one\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_ONE_URL\")\n}\n\nmodel User {\n  id    Int     @id @default(autoincrement())\n  email String  @unique\n  name  String?\n  posts Post[]\n}\n\nmodel Post {\n  id        Int      @id @default(autoincrement())\n  title     String\n  content   String?\n  published Boolean? @default(false)\n  author    User?    @relation(fields: [authorId], references: [id])\n  authorId  Int?\n}\n",
  "inlineSchemaHash": "32cec960afe3a55b5684d448f59ace323a7fd01c1c5c06df559c753f688ab96d",
  "copyEngine": false,
  "runtimeDataModel": {
    "models": {},
    "enums": {},
